...
public class PopupNotificationActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    private ActionBar actionBar;    //操作栏
    private ChatActivityEnterView chatActivityEnterView;
    private BackupImageView avatarImageView; //化身图像视图
    private TextView nameTextView;  //名称文本视图
    private TextView onlineTextView;        //行文本视图
    private FrameLayout avatarContainer;  //的容器
    private TextView countText;  //计算文本
    private ViewGroup messageContainer; //消息的容器
    private ViewGroup centerView;   //中心视图
    private ViewGroup leftView;     //左视图
    private ViewGroup rightView;    //右视图
    private RelativeLayout popupContainer;  //弹出容器
    private ArrayList<ViewGroup> textViews = new ArrayList<>();     //文本视图
    private ArrayList<ViewGroup> imageViews = new ArrayList<>();        //图片视图
    private ArrayList<ViewGroup> audioViews = new ArrayList<>();        //音频视图
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatActivityEnterView.setDelegate(new ChatActivityEnterView.ChatActivityEnterViewDelegate() {
            ...
            public void onMessageSend(CharSequence message) {
                Logs.s("    改变消息数据   popopnotification    "+message);
