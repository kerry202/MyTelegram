...
public class EmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface Listener {
        boolean onBackspace();  //在退格
        void onEmojiSelected(String emoji); //在Emoji选择
        void onStickerSelected(TLRPC.Document sticker); //在选择贴纸
        void onStickersSettingsClick(); //在标签设置点击
        void onStickersGroupClick(int chatId); //在贴纸组点击
    ...
    private TrendingGridAdapter trendingGridAdapter; //趋势网格适配器
    ...
    public EmojiView(boolean needStickers, boolean needGif, final Context context, final TLRPC.ChatFull chatFull) {
        ...
        pagerSlidingTabStrip.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                Logs.s("  pagerSlidingTabStrip    onPageScrolled  "+position +"  ###  "+positionOffset+"  ##  "+positionOffsetPixels);
            ...
            public void onPageSelected(int position) {
                saveNewPage();
                Logs.s("  pagerSlidingTabStrip    onPageSelected  "+position );
            }

            @Override
            public void onPageScrollStateChanged(int state) {
                Logs.s("  pagerSlidingTabStrip    onPageScrollStateChanged  "+state );
            }
        });
