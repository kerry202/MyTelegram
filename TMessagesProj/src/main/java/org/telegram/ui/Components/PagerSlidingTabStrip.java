...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void notifyDataSetChanged() {
        ...
        Logs.s("  pager 通知数据集变化 tabCount  "+tabCount);
        for (int i = 0; i < tabCount; i++) {

            if (pager.getAdapter() instanceof IconTabProvider) {
                Logs.s("  pager 通知数据集变化 addIconTab  "+tabCount);
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                Logs.s("  pager 通知数据集变化 onGlobalLayout  ");
    ...
    private void addIconTab(final int position, Drawable drawable) {
        ...
        Logs.s("   tabtab " +drawable.toString());

        //设置表情包teb   icon
        tab.setImageDrawable(drawable);
//        tab.setImageResource(R.drawable.redcircle);
