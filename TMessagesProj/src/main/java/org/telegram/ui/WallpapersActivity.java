...
public class WallpapersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        Logs.s("   WallpapersActivity  createView   111  " );
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                Logs.s("   WallpapersActivity  setActionBarMenuOnItemClick   111  " );
                if (id == -1) {
                    finishFragment();
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Logs.s("   WallpapersActivity  onItemClick  " +position);
    ...
    public void onActivityResultFragment(int requestCode, int resultCode, Intent data) {
        Logs.s("   WallpapersActivity  onActivityResultFragment   111  " );
        updater.onActivityResult(requestCode, resultCode, data);
    }

    @Override
    public void saveSelfArgs(Bundle args) {
        Logs.s("   WallpapersActivity  saveSelfArgs   111  " );
    ...
    public void restoreSelfArgs(Bundle args) {
        Logs.s("   WallpapersActivity  restoreSelfArgs   111  " );
        updater.setCurrentPicturePath(args.getString("path"));
    }

    private void processSelectedBackground() {
        Logs.s("   WallpapersActivity  processSelectedBackground   111  " );
        if (Theme.hasWallpaperFromTheme() && !overrideThemeWallpaper) {
            ...
            if (selectedBackground != -1 && selectedBackground != 1000001 && wallPaper != null && wallPaper instanceof TLRPC.TL_wallPaper) {
                ...
                if (selectedBackground == 1000001) {
                    Logs.s("   WallpapersActivity  onItemClick   111  " );
