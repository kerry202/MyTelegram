...
public class MessageObject {
    ...
    public static final int MESSAGE_SEND_STATE_SENDING = 1; //消息发送状态发送
    public static final int MESSAGE_SEND_STATE_SENT = 0;  //消息发送状态发送
    public static final int MESSAGE_SEND_STATE_SEND_ERROR = 2;  //消息发送状态发送

    public long localGroupId;  //本地组Id
    public TLRPC.Message messageOwner;  //信息所有者
    public CharSequence messageText;   //消息文本
    public CharSequence linkDescription;  //链接描述
    public CharSequence caption;   //标题
    public MessageObject replyMessageObject;   //应答消息对象
    public int type = 1000;
    private int isRoundVideoCached;  //是圆的视频缓存
    public long eventId;    //标识符
    public int contentType;   //内容类型
    public String dateKey;   //关键日期
    public String monthKey;  //月的关键
    public boolean deleted;   //删除
    public float audioProgress;  //音频的进展
    public float gifState;   //gif 状态
    public int audioProgressSec;  //音频进步交会
    public boolean isDateObject;  //是日期对象
    public ArrayList<TLRPC.PhotoSize> photoThumbs;  //笨手笨脚的照片
    public ArrayList<TLRPC.PhotoSize> photoThumbs2;
    public VideoEditedInfo videoEditedInfo;  //视频编辑的信息
    public boolean viewsReloaded;   //视图重新加载
    public int wantedBotKeyboardWidth;   //希望机器人键盘的宽度
    public boolean attachPathExists;   //附加路径
    public boolean mediaExists;   //媒体的存在
    public boolean resendAsIs;   //重新发送,
    public String customReplyName;   //自定义回复名字
    public boolean useCustomPhoto;   //使用自定义照片
    public StringBuilder botButtonsLayout;  //机器人按钮布局

    public TLRPC.TL_channelAdminLogEvent currentEvent;   //当前事件

    public boolean forceUpdate;   //强制更新

    public int lastLineWidth;   //最后一行的宽度
    public int textWidth;   //文本宽
    public int textHeight;      //文本高
    public boolean hasRtl;
    public float textXOffset;   //文本X抵消

    private boolean layoutCreated;   //创建的布局
    private int generatedWithMinSize;  //生成最小大小

    public static Pattern urlPattern;  //url模式
    ...
    public String toString() {
        return "MessageObject{" +
                ...
                ", type=" + type +
                ", isRoundVideoCached=" + isRoundVideoCached +
                ", eventId=" + eventId +
                ...
                ", photoThumbs2=" + photoThumbs2 +
                ", videoEditedInfo=" + videoEditedInfo +
                ", viewsReloaded=" + viewsReloaded +
                ", wantedBotKeyboardWidth=" + wantedBotKeyboardWidth +
                ", attachPathExists=" + attachPathExists +
                ", mediaExists=" + mediaExists +
                ", resendAsIs=" + resendAsIs +
                ", customReplyName='" + customReplyName + '\'' +
                ...
                ", generatedWithMinSize=" + generatedWithMinSize +
    ...
    public static class TextLayoutBlock {
        ...
        public String toString() {
            return "TextLayoutBlock{" +
                    ...
                    ", charactersEnd=" + charactersEnd +
                    ", height=" + height +
                    ", heightByOffset=" + heightByOffset +
                    ", directionFlags=" + directionFlags +
                    '}';
        }
    }

    public static final int POSITION_FLAG_LEFT = 1; //位置标志左
    public static final int POSITION_FLAG_RIGHT = 2;//位置标志右
    public static final int POSITION_FLAG_TOP = 4;//位置标志头
    public static final int POSITION_FLAG_BOTTOM = 8;//位置标志底
    ...
    public static class GroupedMessagePosition {
        ...
        public String toString() {
            return "GroupedMessagePosition{" +
                    ...
                    ", last=" + last +
                    ", spanSize=" + spanSize +
                    ", leftSpanOffset=" + leftSpanOffset +
                    ", edge=" + edge +
                    ", flags=" + flags +
                    ", siblingHeights=" + Arrays.toString(siblingHeights) +
                    '}';
        }
    }
    ...
    public static class GroupedMessages {
        ...
        public String toString() {
            return "GroupedMessages{" +
                    ...
                    ", firstSpanAdditionalSize=" + firstSpanAdditionalSize +
                    '}';
        }
        ...
        private class MessageGroupedLayoutAttempt {
            ...
            @Override
            public String toString() {
                return "MessageGroupedLayoutAttempt{" +
                        "lineCounts=" + Arrays.toString(lineCounts) +
    ...
    public void generateLayout(TLRPC.User fromUser) {
        ...
        try {
            ...
            if (hasUrls && Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Logs.s(" messageTextmessageText 444  "+messageText);
                ...
                Logs.s(" messageTextmessageText  "+messageText);
//                String s = (String) messageText;
//                if (s.contains(" https://www.biyong.info/redpacket.html#/id/PSD7g4%2FXX71WyAJbjTd%2BI3ueXZq3NRoC2s1AqMC6bhf6NhE2ByQoHYcnkX1mCvaQzDh61QfRof%2FQYeoaxBFDfEgXr%2BQ3etMaz74UXehR4905ZkpHd70ZQ1qInKpDEL")){
//                    textLayout = new StaticLayout("", paint, maxWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
//                }else {
...
//                }
        ...
        for (int a = 0; a < blocksCount; a++) {
            ...
            if (blocksCount == 1) {
                ...
                try {
                    if (hasUrls && Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        Logs.s(" messageTextmessageText 222  "+messageText);
                        ...
                        Logs.s(" messageTextmessageText 111  "+messageText);
