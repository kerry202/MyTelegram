...
public class ImageReceiver implements NotificationCenter.NotificationCenterDelegate {
    ...
    private Drawable currentImage;  //当前图像
    private Drawable currentThumb; //目前的经验
    private Drawable staticThumb;   //静态的拇指
    ...
    public void setImage(TLObject fileLocation, String httpUrl, String filter, Drawable thumb, TLRPC.FileLocation thumbLocation, String thumbFilter, int size, String ext, int cacheType) {
        ...
        bitmapShaderThumb = null;
        currentAlpha = 1.0f;
        Logs.s(" 设置聊天图片 20 currentThumbKey  "+currentThumbKey);
        Logs.s(" 设置聊天图片 20  currentKey  "+currentKey);
        Logs.s(" 设置聊天图片 20 currentExt  "+currentExt);
        Logs.s(" 设置聊天图片 20  currentImageLocation "+currentImageLocation);
        Logs.s(" 设置聊天图片 20  currentHttpUrl "+currentHttpUrl);
        Logs.s(" 设置聊天图片 20  currentFilter "+currentFilter);
        Logs.s(" 设置聊天图片 20  currentThumbFilter "+currentThumbFilter);
        Logs.s(" 设置聊天图片 20 currentSize  "+currentSize);
        Logs.s(" 设置聊天图片 20  currentCacheType "+currentCacheType);
        Logs.s(" 设置聊天图片 20  currentThumbLocation "+currentThumbLocation);
        Logs.s(" 设置聊天图片 20  staticThumb "+staticThumb);
